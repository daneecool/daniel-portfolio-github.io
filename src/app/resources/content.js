...
const baseURL = "https://daneecool.github.io/daniel-portfolio-github.io"; // Ensure the full URL is used
...
const home = {
  ...
  headline: <>Mechanical, Electrical Informatics and Front-End Engineer</>,
  subline: (
    <>
    ...
    experiences: [
      {
        ...
        images: [
          ...
          {
            src: `${baseURL}/images/projects/project-01/cover-01.jpg`,  // begin here to add on image
